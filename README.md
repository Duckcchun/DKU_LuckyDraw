...
| 11 | 비로그인 접근 제한 | 구매 페이지 접근 시 로그인 리다이렉트 | ✅ |
| 12 | 일반 사용자 관리자 접근 차단 | 403 Forbidden 또는 리다이렉트 | ✅ |
...
### 사용 도구
- **Kiro (AI Assistant)**: 코드 생성, 프로젝트 구조 설계, 보고서 작성
...
| Docker 설정 | Dockerfile, docker-compose.yml, nginx.conf 작성 |
